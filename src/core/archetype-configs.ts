...
import { ArchetypeConfig, ArchetypeName, DecisionType } from '../types/archetypes';

// Valores de DecisionType como objeto para uso en runtime
export const DECISION_TYPES: Record<DecisionType, DecisionType> = {
  MERCY: 'MERCY',
  JUSTICE: 'JUSTICE',
  WISDOM: 'WISDOM',
  SACRIFICE: 'SACRIFICE',
 ...
 */
export function getArchetypeConfig(name: ArchetypeName): ArchetypeConfig {
 ...
 */
export function getArchetypesByGender(gender: 'MASCULINE' | 'FEMININE'): ArchetypeConfig[] {
 ...
 */
export function getArchetypesByDecisionType(decisionType: DecisionType): ArchetypeConfig[] {
 ...
 */
export const ALL_ARCHETYPE_NAMES: ArchetypeName[] = Object.keys(ARCHETYPE_CONFIGS) as ArchetypeName[];
